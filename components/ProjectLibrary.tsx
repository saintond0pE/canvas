    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {projects.length > 0 ? (
        ...
        <div className="text-center py-24 border-2 border-dashed border-gray-300 rounded-2xl">
          ...
          <h3 className="mt-4 text-xl font-semibold text-gray-900">No projects yet</h3>
          <p className="mt-1 text-md text-gray-500">Get started by creating a new project.</p>
          <div className="mt-6">
